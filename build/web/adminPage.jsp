<%-- 
    Document   : adminPage
    Created on : Feb 4, 2022, 10:39:23 AM
    Author     : ADMIN
--%>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow border-0 mb-7">
                            <div class="card-header">
                                <form action="filter?action=filter&from=admin" method="post" style="float: right">
                                    <input id="cus" type="number" name="cus" value=""  placeholder="Enter customer ID" style="border: solid 2px #000; border-radius: 0.5em;" required="" >
                                        ...
                                        <select onclick="change()" id="select" name="select" style="border: solid 2px #000; border-radius: 0.5em; background-color: gainsboro; text-align: center; ">
                                            <option value="customer" onclick="change()" >By Customer</option>
                                        ...
                                        <script>
                                            function change(){
                                               ...
                                               if(value==="date" ){
                                                   ...
                                                   document.getElementById("cus").removeAttribute("required");
                                               ...
                                               console.log(value);
                                               console.log(document.getElementById("cus").value);
                                           }
                                        </script>
                                </form>
                            </div>
                            <div class="table-responsive" >
                                        ...
                                        <tr >
                                            ...
                                            <td> 
                                                <c:if test="${o.orderStatus==2}">
                                                    <span class="badge badge-lg badge-dot"> <i class="bg-success"></i>Success </span>
                                                    
                                                </c:if> 
                                                <c:if test="${o.orderStatus==1}">
                                                    <span class="badge badge-lg badge-dot"> <i class="bg-warning"></i>Process </span>
                                                    
                                                </c:if> 
                                                <c:if test="${o.orderStatus==3}">
                                                    <span class="badge badge-lg badge-dot"> <i class=" bg-danger "></i>Cancel </span>
                                                </c:if> 
                                            </td>
                                            <td>${o.accId}</td>
                             ...
                             <div class="card-footer border-0 py-5"> <span class="text-muted text-sm">${!sessionScope.product.isEmpty()?"Showing 10 items out of 250 results found":"0 results was found"}</span> </div>
                        </div>
                    </div>
                </main>
            </div>
