...
public class CategoriesServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            ArrayList<Product> product = ProductDaO.getProduct(categories);
            ArrayList<Categories> listC = new CategoriesDaO().getCategorieses();
            request.setAttribute("listCate", product);
            request.setAttribute("listC", listC);
            request.getRequestDispatcher("categoriesPage.jsp").forward(request, response);
        }
    }
