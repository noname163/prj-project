<%-- 
    ...
    Created on : Jan 24, 2022, 9:03:54 AM
    Author     : ADMIN
--%>
        ...
        <div class="container">
            ...
            <jsp:include page="Left.jsp"></jsp:include>
                ...
                <div class="col-sm-9">
                    <div class="row">
                        <h1>${Empty}</h1>
                        <c:forEach items="${searchList}" var="o">
                            <div class="col-12 col-md-6 col-lg-4">
                                <div class="card">
                                    <img class="card-img-top" src="${o.productImg}" alt="Card image cap" width="200px" height="250px">
                                    <div class="card-body">
                                        <h4 class="card-title show_txt"><a href="mainController?action=detail&Dvalue=${o.productName}" title="View Product">${o.productName}</a></h4>
